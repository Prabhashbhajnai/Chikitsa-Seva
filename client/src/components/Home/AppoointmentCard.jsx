            ...
            <div className='bg-white mx-2 p-2 px-4 w-full mb-2 rounded-2xl transition shadow-lg duration-700 ease-in-out hover:shadow-2xl  md:w-1/2 lg:w-1/4'>
                ...
                <div className='h-3/4'>
                    <div className='flex items-center justify-between'>
                        ...
                        <div>
                            <h1 className='font-semibold'>Dr. Anurag Krishna Yadav</h1>
                    ...
                    <div className='flex justify-around mt-5'>
                        <div className='flex flex-col juatify-between gap-5 mt-3'>
                            <div className='w-2/5'>
                                ...
                                <h1 className='text-[13px] font-medium'>Monday, 02/01/2023</h1>
                            </div>
                            <div className='w-2/5'>
                                <h1 className='text-slate-400 font-medium'>Address</h1>
                                <h1 className='text-[13px] font-medium'>Katra, Prayagraj, UP</h1>
                            </div>
                        </div>
                        <div className='flex flex-col gap-5 mt-3'>
                            <div className='w-2/5'>
                                <h1 className='text-slate-400 font-medium'>Time</h1>
                                <h1 className='text-[13px] font-medium'>10:20-10:20</h1>
                            </div>
